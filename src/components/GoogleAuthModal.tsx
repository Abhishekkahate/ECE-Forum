        ...
        {!showManualForm ? (
          <div className="space-y-3">
            <button
              ...
              disabled={isLoading}
              className="w-full py-3.5 px-5 rounded-full bg-white text-black font-bold text-sm hover:bg-white/90 hover:shadow-[0_0_24px_rgba(255,255,255,0.4)] transition-all flex items-center justify-center gap-3 disabled:opacity-50 cursor-pointer"
            >
            ...
            <button
              ...
              className="w-full py-2.5 text-center text-xs font-mono text-white/50 hover:text-white transition-colors cursor-pointer"
            >
              Or enter email address directly &rarr;
            </button>
          </div>
        ) : (
          <form onSubmit={handleManualSubmit} className="space-y-4 font-mono text-xs">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-[#121216] border border-white/10 rounded-2xl p-3 text-white focus:outline-none focus:border-[#FF4A15]"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-[#121216] border border-white/10 rounded-2xl p-3 text-white focus:outline-none focus:border-[#00E5CC]"
              />
            </div>

            <button
              type="submit"
              className="w-full py-3.5 rounded-full bg-[#FF4A15] text-white font-[Syne] font-bold text-xs tracking-wider shadow-[0_0_20px_rgba(255,74,21,0.3)] hover:bg-white hover:text-black transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
            ...
            <button
              ...
              className="w-full text-center text-[11px] text-white/40 hover:text-white pt-1 cursor-pointer"
            >
              &larr; Back to Google OAuth
            </button>
          </form>
        )}
