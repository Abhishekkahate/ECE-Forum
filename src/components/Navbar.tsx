            ...
            <div className="p-3.5 space-y-3 max-h-[78vh] overflow-y-auto custom-scrollbar">
              ...
              <div className="grid grid-cols-3 gap-2 pt-2 border-t border-white/[0.07]">
                <button
                  ...
                  className="py-2.5 px-2 rounded-xl bg-[#FF4A15]/10 border border-[#FF4A15]/20 text-[#FF4A15] font-mono text-[11px] font-bold flex flex-col items-center justify-center gap-1"
                >
